...
/* ============================================================
   4. Update Course
============================================================ */
router.put("/:courseId", verifyToken, verifyAdmin, async (req, res) => {
  try {
...
============================================================ */
router.post("/:courseId/module/add", verifyToken, verifyAdmin, async (req, res) => {
  try {
...
router.post("/:courseId/module/:moduleId/topic/add", verifyToken, verifyAdmin, async (req, res) => {
  try {
...
============================================================ */
router.post("/:courseId/module/:moduleId/quiz/add", verifyToken, verifyAdmin, async (req, res) => {
  try {
...
/* ============================================================
   9. Update Module
============================================================ */
router.put("/:courseId/module/:moduleId", verifyToken, verifyAdmin, async (req, res) => {
  try {
    const course = await Course.findOne({ courseId: req.params.courseId });
    if (!course) return res.status(404).json({ message: "Course not found" });
...
/* ============================================================
   10. Delete Module
============================================================ */
router.delete("/:courseId/module/:moduleId", verifyToken, verifyAdmin, async (req, res) => {
  try {
    const course = await Course.findOne({ courseId: req.params.courseId });
    if (!course) return res.status(404).json({ message: "Course not found" });
